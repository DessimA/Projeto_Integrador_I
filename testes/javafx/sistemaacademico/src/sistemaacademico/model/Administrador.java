...
public class Administrador {
    ...
    private @Getter @Setter String matricula = "100";
    private @Getter @Setter String nome = "Administrador";
    ...
    public int criarTurma(String codigo, Curso curso, Disciplina disciplina, Professor professor) {
        ...
        codigo = codigo + "-" + disciplina.getNome();// DEFININDO UM CODIGO PERSONALIZADO PARA A TURMA
                                                     // (EX:'123-Algoritmo')
