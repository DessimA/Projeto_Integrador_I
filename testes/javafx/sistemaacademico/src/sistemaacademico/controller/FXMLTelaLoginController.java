            ...
            case '1':// ALUNO
                if (administrador.getAlunos().size() != 0) {
                    for (int i = 0; i < administrador.getAlunos().size(); i++) {
                        if (matricula.equals(administrador.getAlunos().get(i).getMatricula())
                                && senha.equals(administrador.getAlunos().get(i).getSenha())) {
                            naoEncontrou = false;
            ...
            case '2':// PROFESSOR
                if (administrador.getProfessores().size() != 0) {
                    for (int i = 0; i < administrador.getProfessores().size(); i++) {
                        if (matricula.equals(administrador.getProfessores().get(i).getMatricula())
                                && senha.equals(administrador.getProfessores().get(i).getSenha())) {
